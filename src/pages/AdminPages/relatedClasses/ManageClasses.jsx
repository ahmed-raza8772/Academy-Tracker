...
export default function ManageClasses() {
  ...
  // 💡 Handlers defined in ManageClasses (for logic handling)

  // const handleEdit = (classItem) => {
  //   console.log("Edit Class:", classItem.classCode);
  //   // YOUR EDIT/MODAL/NAVIGATION LOGIC GOES HERE
  // };
  ...
  // Combine handlers into an object to pass easily
                        ...
                        >
                          ...
                          <TableCell className="px-4 py-3 text-start">
                            <div className="flex items-center gap-3">
                              <button
                                onClick={() => handleView(order)} // open a separate modal
          ...
          <div className="relative w-full p-4 overflow-y-auto bg-white no-scrollbar rounded-3xl dark:bg-gray-900 lg:p-11">
            ...
            <div className="px-2 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2 ">
                <div>
                  <Label>Class Code</Label>
                  <Input type="text" value={selectedClass?.classCode || ""} />
                </div>
                <div>
                  <Label>Class Name</Label>
                  <Input type="text" value={selectedClass?.className || ""} />
                </div>
                <div>
                  <Label>Grade</Label>
                  <Input type="text" value={selectedClass?.grade || ""} />
                </div>
              </div>
            </div>
          </div>
