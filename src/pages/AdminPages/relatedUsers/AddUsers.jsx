...
export default function AddUsers() {
  ...
  const handleChange = (e) => {
    ...
    setFormData((prev) => {
      ...
      // Reset teacherType when role changes to non-teacher
      if (name === "role") {
        if (value !== "teacher") {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Prepare data for API - send teacherType = null for non-teacher roles
      const userData = {
        ...
        role: formData.role,
        teacherType: formData.role === "teacher" ? formData.teacherType : null,
      };
